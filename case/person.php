<?php 
	...
	// p($name);
	$sql = "SELECT `id`,`name`,`sex`,`email`,`aname`,tel FROM ".PRE."user WHERE `name`='$name'";
	$list=query($link,$sql);
	$list=$list['0'];
	$_SESSION['home']['aname']=$list['aname'];
	// p($list);
	// p($_SESSION);
	...
	<div class="row mt20" >
		<div class="col-md-2">
		        ...
		        <div class="panel-heading">
		          <a data-toggle="collapse" data-parent="#accordion" href=".person.php">
		            <h4 class="panel-title">
		              <a href="./person.php"><h4 class="panel-title">个人资料</h4></a>
		            </h4>
		          </a>
		        </div>
		    </div>
		  ...
		  <div class="panel panel-success">
			...
			<form action="./com/persondo.php" method="post">
				<div class="col-md-8 ">
					<h1>个人资料</h1>
					<div class="row">
						<div class="col-md-2"><span><h4>用户名:</h4></span></div>
						<div class="col-md-6 ">
							<input type="text" name="aname" class="form-control" placeholder="请设置你的用户名" value="<?php echo $list['aname'] ?>">
						</div>
					<div class="col-md-4"></div>
				</div>
					<div class="row">
						<div class="col-md-2"><span><h4>email:</h4></div>
						<div class="col-md-6 ">
					...
					<div class="row ">
						<div class="col-md-2"><span><h4>tel:</4></div>
						<div class="col-md-6 ">
