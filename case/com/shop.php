    ...
    <div class="row mt50">
        ...
        <div class="col-md-8 pull-right">
            ...
            <form action="./com/cartdo.php" method="get">
                ...
                <div class="row mt30">
                    <div style="height:5px;" class="col-md-12 bg-primary mt20"></div>
                    <div class="col-md-12 mt20">
                        <!-- 点击后跳转到购物车页面 -->
                        <button type="submit" name="a" value="buy" class="btn btn-danger col-md-12" <?php echo $list['stock']==0?'disabled':''; ?>>立即购买</button>
                    </div>
                    <div class="col-md-12 mt20">
                        <!-- 点击后跳转到购物车页面 -->
                      
                        <!-- 点击后只加入购物车的内容,页面不跳转 -->
                        <button type="submit" name="a" value="add" class="btn btn-success col-md-12" onclick="if(confirm('你确定要加入购物车吗?')==false)return false">
                            加入购物车
                        </button>
                    </div>
                </div>
