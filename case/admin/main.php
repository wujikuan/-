...
<div class="container-fluid">
    <div class="row">
        <h1 class="col-md-12">蘑菇商城后台管理系统</h1>
        <p class="col-md-12">
            <a href="./user/index.php" class="btn btn-primary">添加用户</a>
            <a href="./goods/add.php" class="btn btn-success">添加商品</a>
            <a href="./goods/index.php" class="btn btn-info">查看商品</a>
